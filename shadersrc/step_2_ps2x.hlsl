...
float4 main( PS_INPUT i ) : COLOR
{
    ...
    paletteOne.hue               = 1.0;
    paletteOne.saturation        = 1.0;
    paletteOne.brightness        = 1.0;
    paletteOne.contrast          = 1.0;
    paletteOne.specular          = Constants0;
    paletteOne.metallic_specular = Constants1;

    // Secondary Pallete
    Palette paletteTwo;

    paletteTwo.hue               = 1.0;
    paletteTwo.saturation        = 1.0;
    paletteTwo.brightness        = 1.0;
    paletteTwo.contrast          = 1.0;
    paletteTwo.specular          = Constants2;
    paletteTwo.metallic_specular = Constants3;
