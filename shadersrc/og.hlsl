...
HuePixelData HuePixel(Palette palette, float4 _hColor, float4 _mColor, float4 _dColor)
{
    HuePixelData result;
    ...
    result.specular_color = vecMulti_One * vecMulti_Two;
...
float4 main( PS_INPUT i ) : COLOR
{
    ...
    // Normal Map - Normal/rotation data + emissive + opacity
    ...
    HuePixelData test = HuePixel(palette_to_use, palettemap, palettemaskmap, diffuse);
